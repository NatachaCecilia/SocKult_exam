...
mcmc_trace(m_emp, pars = "xxxxx") + theme_classic()
...
plot(hypothesis(m_emp, "conditionimagine_other > 0", class = "sd", group ="ID"))
...
#Exponentiate the values from summary- Wee see the values given in the conditiona effects
exp(3.78)
exp(3.90)
exp(3.89)
