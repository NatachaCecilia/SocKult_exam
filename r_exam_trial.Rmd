...
ggplot(d_scale, aes(scaled_distress, scaled_empathy, colour = condition)) +
  geom_point() + 
  theme_classic() +
  geom_smooth(method=lm, aes(scaled_distress, scaled_empathy, colour = condition) +
  ggtitle("Correlation between distress and empathy")
